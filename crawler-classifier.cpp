...
//Mutex for screen  output access
...
int main(int argc, char **argv)
{
    ...
    int M = atoi(argv[4]);
    cout << setw(16) << "crawler1" << setw(16) << "crawler2" << setw(16) << "crawler3" << setw(16) << "classifier" << setw(16) << "s-manager" << endl;
    pthread_t crawler1, crawler2, crawler3, classifier, strategy_manager;
    ...
    arg_struct args1 = {interval_A, 1, M};
    arg_struct args2 = {interval_A, 2, M};
    arg_struct args3 = {interval_A, 3, M};
